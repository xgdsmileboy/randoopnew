...
public class StringLineIterator {
	...
	/**
	 * Returns a line of words, ensuring that the length of the line is no
	 * greater than the given length. If such a line is not possible, returns an
	 * empty String.
	 *
	...
	public String nextLine(int length) {
		...
		for (;;) {
			...
			if (lengthWithNextWord > length) {
				...
				// last word currently in the line) would make the line too
				// long.
