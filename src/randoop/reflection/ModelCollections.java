...
/**
 * Abstract class for representing collections of types and operations for a set
 * of classes. Includes:
 * <ul>
...
public abstract class ModelCollections {
	 ...
	 *
	 * @param type
	 *            the {@link ConcreteType} to add to the class types collection
	 */
	 ...
	 *
	 * @param type
	 *            the {@link GenericClassType} to add to the class types
	 *            collection
	 */
