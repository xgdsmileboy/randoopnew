...
/**
 * {@code InputTypeExtractor} is a {@link ClassVisitor} that extracts concrete
 * types that are used in a class as either a parameter, a return type, or a
 * field type.
 */
class InputTypeExtractor implements ClassVisitor {
	...
	/**
	 * {@inheritDoc} Adds all concrete parameter types from the constructor to
	 * the input types set of this object.
	 */
	@Override
	...
	/**
	 * {@inheritDoc} Adds any concrete type among parameter and return types to
	 * the input types set of this object.
	 */
	@Override
	...
	/**
	 * {@inheritDoc} Adds a concrete field type to the input types set of this
	 * object.
	 */
	@Override
	...
	/**
	 * Determines whether the given general type is not generic, and, if so,
	 * adds the concrete type to the input types of this object.
	 *
	 * @param type
	 *            the general type
	 */
