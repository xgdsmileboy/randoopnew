...
public class SubTypeSet {
	 ...
	 *            the query type
	 * @param match
	 *            the type matching criterion
	 * @return true if either there is a sequence with the query type as its
	 *         output type, or {@code match=COMPATIBLE_TYPE} and there is a
	 *         sequence with a subtype of the query type as its output type.
	 */
