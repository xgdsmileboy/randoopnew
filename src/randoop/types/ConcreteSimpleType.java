...
/**
 * {@code ConcreteSimpleType} represents an atomic concrete type: a primitive
 * type, a non-generic class, an enum, or the rawtype for a generic class. It is
 * a wrapper for a {@link Class} object, which is a runtime representation of a
 * type.
 */
public class ConcreteSimpleType extends ConcreteType {
	...
	public boolean isBoxedPrimitive() {
		return PrimitiveTypes.isBoxedPrimitiveTypeOrString(runtimeClass) && !this.equals(ConcreteTypes.STRING_TYPE);
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @return true if the runtime type corresponds to a generic, false
	 *         otherwise
	 */
	@Override
	...
	/**
	 * {@inheritDoc} Tests for assignability to this {@code ConcreteSimpleType}.
	...
	public boolean isAssignableFrom(ConcreteType sourceType) {
		...
		// to be assignable, other cases must be ConcreteSimpleType to
		// ConcreteSimpleType
	 ...
	 * {@code ConcreteSimpleType}. Checks for identity, widening reference,
	 * widening primitive, boxing, and unboxing conversions.
	 *
	 * @param sourceType
	 *            the source type
	 * @return true if a value of {@code sourceType} can be assigned to a
