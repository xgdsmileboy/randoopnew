...
public class ConcreteTypeBound extends TypeBound {
	...
	/**
	 * Constructs a concrete type bound from a particular concrete type using
	 * the given type order.
	 *
	 * @param boundType
	 *            the type for the bound
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @return true if this concrete type is assignable by argument type, false
	 *         otherwise
	 */
	@Override
