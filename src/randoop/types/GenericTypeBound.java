...
/**
 * Represents a type bound in which a type variable occurs. To evaluate this
 * kind of bound, a substitution is needed to instantiate the bound to a
 * concrete type bound.
 * 
...
public class GenericTypeBound extends TypeBound {
	...
	/**
	 * Creates a {@code GenericTypeBound} from the given rawtype and type
	 * parameters.
	 *
	 * @param rawType
	 *            the rawtype for the type bound
	 * @param parameters
	 *            the type parameters for the type bound
	 */
	...
	/**
	 * {@inheritDoc} This generic type bound is satisfied by a concrete type if
	 * the concrete type formed by applying the substitution to this generic
	 * bound is satisfied by the concrete type.
	 */
	@Override
	 ...
	 * variables of this bound with the given substitution. The substitution
	 * must be for the generic class to which the bound belongs.
	 *
	 * @param substitution
	 *            the substitution for instantiating type variables
	 * @return the concrete type bound formed by substituting type variables
	 *         with the concrete types using the substitution
	 * @throws IllegalArgumentException
	 *             if either an argument is not a type variable, or a type
	 *             variable has no instantiation in the substitution
	 */
	...
	/**
	 * {@inheritDoc} As a hack to return something usable, returns
	 * {@code Object}, but needs to be bound based on parameter.
	 */
	@Override
