...
class GenericParameterizedType extends GenericType {
	...
	public GenericParameterizedType(GenericClassType instantiatedType, Substitution substitution,
	...
	public String getName() {
		return getRuntimeClass().getCanonicalName() + "<" + UtilMDE.join(argumentList, ",") + ">";
	}
