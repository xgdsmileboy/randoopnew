...
/**
 * {@code GeneralTypeTuple} represents an ordered tuple of type objects. Type
 * tuples primarily used to represent the input types of operations.
 */
public interface GeneralTypeTuple {
	...
	/**
	 * Applies a substitution to a type tuple, replacing any occurrences of type
	 * variables. Resulting tuple may only be partially instantiated.
	 *
	 * @param substitution
	 *            the substitution
	 * @return a new type tuple resulting from applying the given substitution
	 *         to this tuple
	 */
