 ...
 * <p>
 * Java requires that an intersection type bound consist of class and interface
 * types, with at most one class, and if there is a class it appears in the
 * conjunction term first. So, this class preserves the order of the types, just
 * in case it becomes necessary to dump the bound to compilable code.
 */
public class IntersectionTypeBound extends TypeBound {
	...
	// XXX this could be relaxed. Only require that the first argument be first,
	// if it is a class
	@Override
	...
	/**
	 * {@inheritDoc} Checks whether the argument type satisfies all of the
	 * bounds in this intersection type bound.
	 */
	@Override
	...
	/**
	 * {@inheritDoc} It is not possible to create a {@code Class} object for an
	 * intersection type, so this returns the runtime class of the first bound
	 * or {@code Object}.
	 */
	@Override
