...
/**
 * {@code GenericTypeTuple} represents a tuple of generic types, primarily as
 * the input to a {@link GenericOperation GenericOperation}.
 */
public class GenericTypeTuple implements GeneralTypeTuple {

	/**
	 * The ordered typeList of {@link randoop.types.GenericType GenericType}
	 * objects
	 */
	 ...
	 *
	 * @param typeList
	 *            the list of {@link GenericType} objects
	 */
	 ...
	 * @return the concrete type tuple formed by applying the substitution
	 *         componentwise to this tuple
	 */
