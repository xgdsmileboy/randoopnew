 ...
 * <ul>
 * <li>A {@link randoop.contract.ObjectContract} responsible for performing the
 * actual check on a set of runtime values. For example. the class
 * {@link randoop.contract.EqualsReflexive} is a checker code class that, given
 * an object <i>o</i>, calls <i>o.equals(o)</i> and checks that it returns
 * <code>true</code>.
 *
