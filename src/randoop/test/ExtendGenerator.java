...
public class ExtendGenerator implements TestCheckGenerator {
	 ...
	 * {@code ExecutableSequence} objects using the two
	 * {@code TestCheckGenerator} objects. Returns checks produced by the
	 * second, unless the first produces checks that either have error or
	 * invalid behavior.
	 *
