...
public abstract class ExceptionCheck implements Check {
	 ...
	 * generated code for this check will include a try-catch block with
	...
	/**
	 * {@inheritDoc} Returns the post-statement portion of the try-catch
	 * wrapper. Starts with post-statement try-behavior as determined by a
	 * subclass implementation of {@link #appendTryBehavior}, and then closes
	 * with the catch clause with the body determined by the sub-class
	 * implementation of {@link #appendCatchBehavior(StringBuilder, String)}.
	...
	/**
	 * Appends code for catch block behavior corresponding to expected
	 * exception.
	 *
	 * @param b
