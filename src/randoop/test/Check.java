 ...
 * <li>{@link ObjectCheck} -- a particular
 * {@link randoop.contract.ObjectContract} should hold
 * </ul>
 *
...
public interface Check {
	 ...
	 * if these identifiers match. The value is NOT included. with. Used to
	 * match up checks between the same sequence run at different times. Note
	 * that because of changes in the environment (e.g., static variables), two
