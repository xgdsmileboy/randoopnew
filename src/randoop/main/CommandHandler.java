...
public abstract class CommandHandler {
	 ...
	 */
	public CommandHandler(String command, String pitch, String commandGrammar, String where, String summary,
	 ...
	 *
	 * @param out
	 *            the output stream for printing html formatted usage
	 */
	...
	public final void usageMessage(PrintStream out) {
		...
		if (fnotes != null && fnotes.size() > 0) {
			...
			for (int i = 0; i < fnotes.size(); i++) {
				...
				out.println(Util.hangingParagraph(Integer.toString(i + 1) + ". " + note, Globals.COLWIDTH,
						Globals.INDENTWIDTH));
			}
		}
		out.println();
