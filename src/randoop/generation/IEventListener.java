...
public interface IEventListener {
	 ...
	 *
	 * @param s
	 *            sequence that was generated and executed in the last
	 *            generation step. Can b null, which means the last step was
	 *            unable to generate a sequence (e.g. due to a bad random
	 *            choice).
	 *
	 * @see randoop.generation.AbstractGenerator
	 */
