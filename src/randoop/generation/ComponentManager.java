...
public class ComponentManager {
	...
	/**
	 * The subset of the sequences that were given pre-generation to the
	 * component manager (via its constructor).
	 */
	 ...
	 *
	 * @param generalSeeds
	 *            seed sequences. Can be null, in which case the seed sequences
	 *            set is considered empty.
	 */
	 ...
	 *
	 * @param type
	 *            the class literal to add for the sequence
	 * @param seq
	 *            the sequence
	 */
	 ...
	 *
	 * @param pkg
	 *            the package to add for the sequence
	 * @param seq
	 *            the sequence
	 */
	...
	/**
	 * Returns all the general component sequences that create values of the
	 * given class. If exactMatch==true returns only sequences that declare
	 * values of the exact class specified; if exactMatch==false returns
	 * sequences declaring values of cls or any other class that can be used as
	 * a cls (i.e. a subclass of cls).
	 *
	 * @param cls
	 *            the query type
	 * @param exactMatch
	 *            the flag whether or not to use subtyping in type matching
	...
	/**
	 * Returns component sequences that create values of the type required by
	 * the i-th input value of the given statement. Any applicable class- or
	 * package-level literals, those are added to the collection as well.
	 *
	 * @param operation
	 *            the statement
	 * @param i
	 *            the input value index of statement
	 * @return the sequences that create values of the given type
	 */
	...
	/**
	 * Returns all sequences that represent primitive values (e.g. sequences
	 * like "Foo var0 = null" or "int var0 = 1"), including general components,
	 * class literals and package literals.
	 *
