 ...
 * input types are represented by an ordered list of {@link GeneralType}
 * objects, and the output type is a single {@link GeneralType} object.
 * <p>
 ...
 * {@link CallableOperation#execute(Object[], PrintStream)} with concrete values
...
public interface Operation extends Comparable<Operation> {
	 ...
	 * declaring class.
	 *
	 * @return true if operation corresponds to static method or field of a
	...
	/**
	 * Indicates whether this object represents a method-call operation (either
	 * static or instance). This excludes getters and setters.
	 *
	...
	/**
	 * Returns the "value" of an operation that is actually a ground term,
	 * meaning a constant of some form. Only null if value is null, otherwise
	 * throws an exception if there is not a reasonable meaning of value for
	 * type of operation.
	 * <p>
