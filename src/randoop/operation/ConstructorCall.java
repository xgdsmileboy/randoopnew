...
public final class ConstructorCall extends CallableOperation {
	...
	public void appendCode(ConcreteType declaringType, ConcreteTypeTuple inputTypes, ConcreteType outputType,
		...
		b.append(isNonStaticMember ? inputVars.get(0) + "." : "").append("new ")
				.append(isNonStaticMember ? declaringClass.getSimpleName() : declaringClassStr).append("(");
	...
	/**
	 * {@inheritDoc} Performs call to the constructor given the objects as
	 * actual parameters, and the output stream for any output.
	 *
	 ...
	 * {@link ConstructorCall#toParseableString(ConcreteType, ConcreteTypeTuple, ConcreteType)}
	 * and returns the corresponding {@link ConstructorCall} object.
	 *
	...
	/**
	 * {@inheritDoc} Determines whether enclosed {@link Constructor} satisfies
	 * the given predicate.
	 *
