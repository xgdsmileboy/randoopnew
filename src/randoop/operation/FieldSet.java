...
public class FieldSet extends CallableOperation {
	...
	/**
	 * Creates a setter {@link Operation} object for a field of a class. Throws
	 * an exception if the field is static final.
	 *
	 * @param field
	 ...
	 * . Exceptions should only be {@link NullPointerException}, which happens
	 ...
	 *
	 * @param inputVars
	 *            the list of input variables. Last element is value to assign.
	...
	public static void parse(String descr, TypedOperationManager manager) throws OperationParseException {
		...
		manager.createTypedOperation(new FieldSet(accessibleField), classType, new GenericTypeTuple(setInputTypeList),
	...
	/**
	 * Determines whether enclosed {@link java.lang.reflect.Field Field}
