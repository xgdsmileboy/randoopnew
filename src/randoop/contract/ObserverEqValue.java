...
public final class ObserverEqValue implements ObjectContract {
	...
	/**
	 * The runtime value of the observer. This variable holds a primitive value
	 * or String.
	 */
	public Object value;
	...
	public ObserverEqValue(ConcreteOperation observer, Object value) {
		...
		assert (this.value == null)
				|| PrimitiveTypes.isBoxedPrimitiveTypeOrString(this.value.getClass()) : "obs value/class = "
						+ this.value + "/" + this.value.getClass() + " observer = " + observer;
	}
	...
	public String toCodeString() {
		...
		} else if (observer.getOutputType().isPrimitive() && (!value.equals(Double.NaN))
