...
public interface ObjectContract {
	 ...
	 *
	 * @param objects
	 *            the actual parameters to this contract
	 * @return true if this contract evaluates to true for the given values, and
	 *         false otherwise
	 * @throws Throwable
	 ...
	 * participates in the contract check should be referred to as "xN" (for N
	 * one of 0, ... , 9). For example, if the expression or arity 2 represents
	 * a call of the equals method between two objects, the comment should be
