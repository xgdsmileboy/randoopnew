...
public class JunitFileWriter {
	 ...
	 * partitions received by writeJUnitTestFiles. It is used to generate the
	 ...
	 * current convention is that a test method is named "test"+i for some
	 * integer i.
	 */
	private Map<String, Integer> classMethodCounts = new LinkedHashMap<String, Integer>();

	/**
	 * JunitFileWriter creates an instance of class holding information needed
	 ...
	 */
	public static File writeJUnitTestFile(String junitOutputDir, String packageName, ExecutableSequence es,
			String className) {
	...
	/**
	 * writeJUnitTestFiles writes a suite of test class files from a list of
	 * lists of executable sequences. Each executable sequence corresponds to a
	 * test method, a list of executable sequences corresponds to a test class,
	 * and the list of lists to a test suite.
	 *
	 * @param seqPartition
	 *            suite of test classes as a list of lists of executable
	 *            sequences
	 ...
	 * parameter. The file is written to the directory pointed to by writer
	 * object in a class whose name is the {@link #masterTestClassName}.
	 *
	...
	public File writeSuiteFile(List<String> additionalTestClassNames) {
		...
		try (PrintStream out = createTextOutputStream(file)) {
			...
			/*
			 * should be done with a joiner - waiting until we can graduate to
			 * Java 8
			 */
	 ...
	 * The file is written to the directory pointed to by writer object in a
	 * class whose name is the {@link #masterTestClassName}.
	 *
	...
	/**
	 * Returns the number of digits in the printed representation of the
	 * argument.
	 */
	...
	private class NameGenerator {
		 ...
		 *
		 * @param prefix a string to be used as the prefix for all generated
		 * names.
		 *
		 ...
		 *
		 * @param prefix is a string to be used as a prefix for all names
		 * generated.
		 */
