...
public final class Statement {
	...
	/**
	 * The operation (method call, constructor call, primitive values
	 * declaration, etc.).
	 */
	 ...
	 */
	MutableStatement toModifiableStatement(List<MutableVariable> inputs, MutableVariable mVariable) {
	...
	/**
	 * execute performs the operation of the statement for the input variables
	 * and returns outcome.
	 *
	 * @param inputs
	...
	/**
	 * isNullInitialization determines if statement represents an initialization
	 * by null value.
	 *
	...
	/**
	 * getConcreteOperation is meant to be a temporary solution to type
	 * confusion in generators. This should go away. Only intended to be called
	 * by {@link Sequence#extend(ConcreteOperation, List)}.
	 *
