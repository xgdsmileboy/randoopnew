...
class VariableRenamer {
	...
	/**
	 * Heuristically transforms variables to better names based on its type
	 * name. Here are some examples: int var0 = 1 will be transformed to int i0
	 * = 1 ClassName var0 = new ClassName() will be transformed to ClassName
	 * className = new ClassName() Class var0 = null will be transformed to
	 * Class clazz = null
	 * 
	 * @param type
	 *            the type to use as base of variable name
